...
namespace frg
{
    FrgRenderer::FrgRenderer(FrgWindow &window, FrgDevice &device)
        : frgWindow{window}, frgDevice{device}
    {
        recreateSwapChain();
        createCommandBuffers();
    }

    FrgRenderer::~FrgRenderer()
    {
        freeCommandBuffers();
    }
    ...
    void FrgRenderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer)
    {
        ...
        VkRect2D scissor{{0, 0}, frgSwapChain->getSwapChainExtent()};
