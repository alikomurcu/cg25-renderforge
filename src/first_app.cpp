...
void FirstApp::run() {
  ...
  // Radius ~3.0
  // t=0: Start position
  cameraAnimationSystem.addKeyframe(0.f, glm::vec3{0.f, -1.f, -1.f},
                                    glm::vec3{0.f, 0.f, 0.f});
  // t=2.5: Middle position
  cameraAnimationSystem.addKeyframe(2.5f, glm::vec3{3.f, -1.f, 2.f},
                                    glm::vec3{0.f, -1.57f, 0.f});
  // t=5.0: Return to start position (Back and Forth loop)
  cameraAnimationSystem.addKeyframe(5.0f, glm::vec3{0.f, -1.f, -1.f},
                                    glm::vec3{0.f, 0.f, 0.f});

  bool isAutoCamera =
      sceneSettings.autoCamera; // Start with animation enabled from config
...
void FirstApp::loadGameObjects() {
  SceneLoader::load(frgDevice, "../resources/scenes/scene0.xml", gameObjects,
                    viewerObject, lightManager, sceneSettings);
}
} // namespace frg