...
namespace frg
{
    FrgPipeline::FrgPipeline(
        ...
        const PipelineConfigInfo &configInfo) : frgDevice(device)
    {
        ...
        const PipelineConfigInfo &configInfo)
    {
        ...
        auto bindingDescriptions = FrgModel::Vertex::getBindingDescriptions();
        auto attributeDescriptions = FrgModel::Vertex::getAttributeDescriptions();
        ...
        if (vkCreateGraphicsPipelines(frgDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS)
        {
